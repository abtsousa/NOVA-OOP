...
public class Main {
	//Constantes que definem os comandos
	 ...
	 public static final String DUPLICATES_NOT_EXIST = "All contacts have different phone numbers.";
	...
	/** Verifica se há contactos com o mesmo número */
	private static void checkDuplicates(ContactBook cbook) {
		if (cbook.searchDupes()) System.out.println(DUPLICATES_EXIST);
		else System.out.println(DUPLICATES_NOT_EXIST);
	}

	/** Devolve o nome associado a um número (adaptado do getPhone) */
